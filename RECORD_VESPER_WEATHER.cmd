...
if errorlevel 1 start "" /D "C:\Program Files\obs-studio\bin\64bit" "%VESPER_OBS_EXE%" --profile "VESPER FHD 60" --collection "VESPER FHD"
tasklist /FI "IMAGENAME eq VesperLinear.exe" /NH | find /I "VesperLinear.exe" >nul
if errorlevel 1 call "%~dp0PLAY_VESPER_WEATHER.cmd"
endlocal
