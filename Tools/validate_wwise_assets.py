    ...
    if capture:
        ...
        while cursor + 8 <= len(data):
            ...
            if tag == b'fmt ':
                ...
                assert fmt in (1, 65534) and bits == 16
            if tag == b'data':
        ...
        report['outputSignal'] = {'channels': channels, 'sampleRate': rate, 'seconds': len(samples)/(channels*rate),
