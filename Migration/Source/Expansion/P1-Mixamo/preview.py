...
ROOT=Path(__file__).resolve().parent;OUT=ROOT.parents[2]/'Evidence/Expansion/P1-Mixamo/source-qa';OUT.mkdir(parents=True,exist_ok=True)
...
bounds=[]
for clip,frames in [('Walk',[1,11,21,31]),('WalkAlternative',[1,9,17,25]),('Idle',[1]),('Stop',[91])]:
