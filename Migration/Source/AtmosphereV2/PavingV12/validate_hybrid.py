...
g=json.loads((OUT/'paving-v12-mesh.json').read_text());m=json.loads((OUT/'hybrid-metadata.json').read_text())
...
qa['mesh_sha256']=hashlib.sha256((OUT/'paving-v12-mesh.json').read_bytes()).hexdigest()
...
assert qa['hero_count']==24 and qa['exposed_stone_count']>0 and qa['fully_submerged_stone_count']>0
qa['passed']=True
