...
def pair(mode):
 ...
 if mode=='material':
  for ob in before.objects.values():ob.data.materials.clear();ob.data.materials.append(rock)
  for ob in after.objects.values():ob.data.materials.clear();ob.data.materials.append(rock)
