...
Status: READY FOR A NEW NATIVE CANDIDATE REVIEW. Candidate 33 used the earlier
flawed cap revision. The final corrected JSON is stable.
...
- 362 raised unequal bark patches remain on the major wood. The existing
...
contact must be verified in the next native candidate because the isolated Blender rig has
no Unity paving. The asset preview does not establish a scene tier, FPS,
movement acceptance, or final adoption.

The initially exposed mid-trunk bridge cap was caught by root-agent review even
after the first local collar correction. Its bridge has now been extended along
the leader centerline with its end fully inside the leader. The final material
and neutral previews were directly opened again: the horizontal sleeve/cuff is
gone. The flawed blend, QA, report and old assessment are preserved in
`rejected-pass2-cuff/`; candidate 33 records that rejected revision.

## Verified export

- 90,768 triangles / 52,628 exported vertices; below 100k triangles.
...
- No zero-area triangles needed discarding in this revision. Eleven tiny cap
  triangles use their geometric face normal to avoid opposing averaged normals.
- Major core has one connected component of 17,899 vertices. Fine branches
...
- Final JSON SHA256:
  `67a756730db9df492229eecd027fd07f991fed42ec6516086ea595e4e356d763`.
