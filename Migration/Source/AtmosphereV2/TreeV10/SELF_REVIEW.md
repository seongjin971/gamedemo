# Historical Tree V10 pass 1 review

**Superseded by pass 2. Read [SELF_REVIEW_PASS2.md](SELF_REVIEW_PASS2.md) for the
current delivered mesh, preview review, measurements, and hashes.** The text
below records the original pass 1 assessment; its exact asset is preserved in
`pass1/`. The top-level JSON and blend now contain pass 2.
