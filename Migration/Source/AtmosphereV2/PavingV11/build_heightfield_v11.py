...
PERIOD=(9.2,4.6); TOP=-.0236; AMPLITUDE=.04; WATER=-.004
...
meta={'source_asset':'ambientCG Tiles130','source_dimensions_m':[2.3,1.15],'art_scale':4.0,'period_m':list(PERIOD),
 'uv_formula':'u=UnityWorldX/9.2; v=UnityWorldZ/4.6; continuous unbounded; no per-row offsets',
