...
public static partial class WorldVisuals {
 ...
 static void Paving(Transform p,float d,float scale,float wet,bool scattered=false){
  var go=Model(p,(scattered?"L04Details/LinearIrregular_":"L02Details/LinearPaving_")+(1+stoneSerial%3),WorldLayout.Point(d)+Vector3.up*.015f,new Vector3(scale,1,scale),stoneSerial%2*180);
