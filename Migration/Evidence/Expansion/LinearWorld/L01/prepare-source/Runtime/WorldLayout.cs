...
public static class WorldLayout {
 ...
 public static float SnowCover(float x,float d){float broad=S(194,265,d),patch=Mathf.PerlinNoise(x*.31f+4,d*.27f)*.28f;return Mathf.Clamp01((broad+patch-.12f)*1.15f);}
