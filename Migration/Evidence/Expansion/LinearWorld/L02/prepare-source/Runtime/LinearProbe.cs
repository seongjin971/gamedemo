...
public sealed class LinearProbe:MonoBehaviour {
 ...
 [Serializable]public class Report{public string mode,device,note;public int width,height,failures,fixtures,frames,clicks,rejected,safetyStops;public float distance;public Vector3 position;public string[] checks,errors;public Perf[] performance;}
