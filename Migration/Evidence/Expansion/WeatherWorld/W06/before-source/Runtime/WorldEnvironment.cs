...
public sealed class WorldEnvironment:MonoBehaviour {
 ...
 void Update(){
  ...
  WeatherAt(snow,player.transform.position+new Vector3(-8,11,0),2000*night*gust);
  WeatherAt(nearSnow,player.transform.position+new Vector3(-9,12,1),450*night*gust);
