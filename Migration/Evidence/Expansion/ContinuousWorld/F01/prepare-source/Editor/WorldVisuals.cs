...
public static partial class WorldVisuals {
 ...
 public static void Waterside(GameObject collision,WorldEnvironment world,string generated){
  ...
  var surface=new Material(Shader.Find("Vesper/ContinuousRiver"));surface.SetColor("_ShallowColor",new Color(.15f,.49f,.53f));surface.SetColor("_DeepColor",new Color(.055f,.28f,.31f));AssetDatabase.CreateAsset(surface,output+"/RiverSurface.mat");
