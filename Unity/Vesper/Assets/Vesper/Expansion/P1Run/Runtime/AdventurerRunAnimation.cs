...
namespace Vesper.Expansion {
    ...
    public sealed class AdventurerRunAnimation : MonoBehaviour {
        public AdventurerMotor motor;
        public AdventurerRunInput input;
        ...
        void OnEnable() {
            ...
            graph = PlayableGraph.Create("P1 walk and run"); graph.SetTimeUpdateMode(DirectorUpdateMode.Manual);
