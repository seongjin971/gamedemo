...
namespace Vesper.Expansion.P2 {
    ...
    public sealed class P2Animation : MonoBehaviour {
        public P2Motor motor;
        public P2RunInput input;
        ...
        void OnEnable() {
            ...
            graph = PlayableGraph.Create("P2 walk and run"); graph.SetTimeUpdateMode(DirectorUpdateMode.Manual);
