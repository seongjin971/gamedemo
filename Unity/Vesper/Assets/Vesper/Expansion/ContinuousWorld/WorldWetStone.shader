...
half4 frag(V i):SV_Target{
 ...
 float2 stoneUV=lerp(i.w.xz*.32,i.uv,_Overlay);
 ...
 half3 n=normalize(half3(0,1,0)+half3(grain-h1,0,grain-h2)*2.2);half3 v=GetWorldSpaceNormalizeViewDir(i.w);half3 albedo=saturate((lerp(tex,half3(grain,grain,grain),.65)-.22)*1.2+.22)*_BaseColor.rgb;
